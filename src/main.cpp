...
// Global state
//
static const uint256 hashGenesisBlockOfficial("0x0000090c54e03f9b2248372b0bb758bf6964b66a75cca8aa460f97a268d9cfee");
static const uint256 hashGenesisBlockTestNet ("0x000008ddced008883906efd123e1e970350ecfb813ca86d45d57869b09283b9d");
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Amazon CEO's wealth soars to new heights while Trump's sinks";
        unsigned int nTimeGenesis=1520389155;
        unsigned int nNonceGenesis=1982308;

        if (fTestNet)
        {
            pszTimestamp="Love will save us all.";
            nTimeGenesis=1520389155;
            nNonceGenesis=640503;
        }
        ...
        printf("%s\n", block.hashMerkleRoot.ToString().c_str());
        if (!fTestNet)
            assert(block.hashMerkleRoot == uint256("0x8a8477d3c8849a955ac805442bce326dc6b233cb49c8cdb2fa0a3bf5a0cf9fa6"));
        else
            assert(block.hashMerkleRoot == uint256("0x6e36918da34f765bb9b9a1491ba813d35e90a10542de2be439391a1a6fad7a1f"));
